...
```bash
./scripts/build-lab-images.sh                   # build 15 target images (root context for flag SDK)
...
./scripts/blackbox/bb-curriculum.sh             # 14 Wave-1/2/3 solves with real per-session flags
