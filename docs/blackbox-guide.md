...
```bash
./scripts/build-lab-images.sh                   # build 11 target images (root context for flag SDK)
...
./scripts/blackbox/bb-curriculum.sh             # 10 Wave-1+2 solves with real per-session flags
